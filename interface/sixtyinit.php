...
$inputdataarr['contact']          = trim(HyItems::arrayItem ( $_REQUEST, 'contact' ));       //联系方式-建议
...
$inputdataarr['qqid']           = trim(HyItems::arrayItem ( $_REQUEST, 'qqid' ));             //QQ的qqid
$inputdataarr['weiboid']           = trim(HyItems::arrayItem ( $_REQUEST, 'weiboid' ));             //微博的weiboid
...
// $log_str .= $checkstring."\n";
// $log_str .= md5($checkstring)."\n";
// $log_str .= $inputdataarr['md5key']."\n";
